    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analytics', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='store.analytic')),
                ('payments', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='store.paymentoption')),
