    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(default='NAW20209238dfacf7b94', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(default='WA299160AC5612', max_length=30)),
                ('gender', models.CharField(choices=[('femme', 'Femme'), ('homme', 'Homme')], default='femme', max_length=50)),
                ...
                ('price_valid_until', models.DateField(default=datetime.date(2020, 10, 23))),
