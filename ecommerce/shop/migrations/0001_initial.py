    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reference', models.CharField(max_length=50)),
                ('transaction', models.CharField(default='bfcd-d99ddcfb203c40baf8b9fd0016e6553d4284855ce013157fa90396600a54c440', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default='NAW6613U', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(default='SF82083CFA4A17', max_length=30)),
                ('gender', models.CharField(choices=[('femme', 'Femme'), ('homme', 'Homme')], default='femme', max_length=50)),
                ...
                ('price_valid_until', models.DateField(default=datetime.date(2020, 7, 21))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('eur', 'Eur'), ('dollars', 'Dollars')], default='eur', max_length=10)),
        ...
        migrations.AddField(
            ...
            name='criterion',
            field=models.ManyToManyField(to='shop.AutomaticCollection'),
        ),
        migrations.AddField(
            model_name='collection',
            name='store',
