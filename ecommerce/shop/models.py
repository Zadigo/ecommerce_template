...
class Image(models.Model):
    ...
    aws_key = models.CharField(
        max_length=50, null=True, blank=True, verbose_name='AWS folder key')
...
class Collection(models.Model):
    ...
    gender = models.CharField(
        max_length=50, choices=GenderChoices.choices, default=GenderChoices.FEMME)
    ...
    criterion     = models.ManyToManyField(AutomaticCollectionCriteria)
...
class ClotheSize(models.Model):
    name = models.CharField(max_length=3, validators=[
    ...
    waist = models.IntegerField(
        validators=[], default=0, verbose_name='waist width')
...
class Product(models.Model):
    ...
    reference = models.CharField(
        max_length=30, default=utilities.create_product_reference())
    ...
    price_valid_until = models.DateField(
        default=utilities.add_to_current_date(d=30))
...
class Discount(models.Model):
    code = models.CharField(
        max_length=10, default=utilities.create_discount_code())
    ...
    collection = models.ManyToManyField(Collection, blank=True, help_text='Apply on an entire collection')
...
class Cart(models.Model):
    ...
    quantity = models.IntegerField(
        default=1, validators=[validators.quantity_validator])
...
class CustomerOrder(models.Model):
    ...
    transaction = models.CharField(
        max_length=200, default=utilities.create_transaction_token())
    ...
    delivery = models.CharField(
        max_length=50, choices=DeliveryChoices.choices, default=DeliveryChoices.STANDARD)
